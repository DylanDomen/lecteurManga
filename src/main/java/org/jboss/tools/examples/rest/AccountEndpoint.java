...
public class AccountEndpoint {
	...
	public Response findById(@PathParam("id") Integer id) {
		TypedQuery<Account> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT a FROM Account a LEFT JOIN FETCH a.role LEFT JOIN FETCH a.ratings LEFT JOIN FETCH a.manga WHERE a.id = :entityId ORDER BY a.id",
						Account.class);
	...
	@GET
	@Produces("application/json")
	public List<Account> listAll(@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		TypedQuery<Account> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT a FROM Account a LEFT JOIN FETCH a.role LEFT JOIN FETCH a.ratings LEFT JOIN FETCH a.manga ORDER BY a.id",
						Account.class);
